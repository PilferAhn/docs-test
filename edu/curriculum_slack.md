*Databricks 교육 커리큘럼 (2.5일 + 과제 발표)*

• Day 1 — Data Engineering (강의 + 실습)
• Day 2 — MLOps (강의 + 실습) → 수업 종료 후 *숙제 부여*
• Day 3 — AI Agent, 반나절 (강의 + 데모) → 종료 후 *과제 발표 준비*
• Day 4 — *과제 발표* (Day 1~2 실습 내용 기반)

_숙제 안내_
• Day 2 종료 후 개인/팀별 과제 부여
• Day 1~2에서 다룬 DE + MLOps 흐름을 직접 구현
• Bronze → Silver → Gold 파이프라인 구성 및 모델 학습까지 포함
• Day 4 발표에서 구현 내용 및 결과 공유
...
6. Compute / Cluster 설정
   • Compute 유형 (All-purpose / Job / SQL Warehouse / Serverless)
...
*Hands-on Lab*
_Day 1 Silver 테이블을 이어받아 Gold → 모델 학습 → 배치 추론까지 연결_
